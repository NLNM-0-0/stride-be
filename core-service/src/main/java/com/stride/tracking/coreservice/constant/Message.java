...
public class Message {
    ...
    public static final String CAN_NOT_FIND_DISTRICTS_NEAR_POINT = "Can not find districts near point";
    public static final String CAN_NOT_FIND_NEAREST_WAY_POINTS = "Can not find nearest way points";
